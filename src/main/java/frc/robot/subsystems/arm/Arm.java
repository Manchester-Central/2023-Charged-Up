...
// All the code for the arm. Includes safety zones to avoid the arm damaging components to the robot and the set speeds and angles for different components of the arm.