...
public class ArmPose {
    ...
    //Pick Poses
    public static final ArmPose PickFlatPose = addStaticPose("PickFlatPose", -180, ExtenderConstants.MinimumPositionMeters + 0.5, 0, CoordinateType.ArmRelative);
    ...
    //Intake Poses
    public static final ArmPose IntakeFlatPose = addStaticPose("IntakeFlatPose", -130, ExtenderConstants.MinimumPositionMeters + 0.5, -180, CoordinateType.FieldRelative);
    public static final ArmPose IntakeWithWristDownPose = addStaticPose("IntakeWithWristDownPose", -130, ExtenderConstants.MinimumPositionMeters + 0.25, -90, CoordinateType.FieldRelative);
    ...
    public static final ArmPose Cone8MidPose = addStaticPose("ConeMidPose", 5, ExtenderConstants.MinimumPositionMeters + 0.15, 0, CoordinateType.ArmRelative);
