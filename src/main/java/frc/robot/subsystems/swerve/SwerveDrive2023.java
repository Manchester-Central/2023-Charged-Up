...
import com.chaos131.swerve.SwerveDrive;
...
public class SwerveDrive2023 extends SwerveDrive {

  private AHRS m_gyro;
  private Limelight m_limelightLeft;
  private Limelight m_limelightRight;

  private SwerveDrive2023(ISwerveModule[] modules, SwerveConfigs config, AHRS gyro, Limelight limelightLeft, Limelight limelightRight) {
  ...
  public static SwerveDrive2023 CreateSwerveDrive(Limelight limelightLeft, Limelight limelightRight) {
    ...
    var backLeft = new SwerveModule2023(
      ...
      ISwerveModule[] modules = {frontLeft, frontRight, backLeft, backRight};

      var gyro = new AHRS(SPI.Port.kMXP);

      var swerveConfigs = new SwerveConfigs()
        // Max speeds
        .setMaxRobotSpeed_mps(RotationSpeedModifier)
        .setMaxRobotRotation_radps(RotationSpeedModifier)
